...
const greeting = {
  ...
  subTitle: emoji(
    "Data-driven IT specialist with 3+ years of experience in cloud, servers, and networking. Proven ability to leverage data for business insights, design cloud solutions, manage servers, and resolve network issues."
  ),
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Operating systems and network infrastructure: Expertise in Windows, Linux, macOS, and network infrastructure."
    ),
    emoji(
  ...
  experience: [
    {
      ...
      descBullets: [
        "Assess the need for technology in the company and deviseplans to meet those needs",
        "Reduced IT costs by 15%: Streamlined IT operations, eliminated unnecessary expenses, and optimized resource utilization. ",
    ...
    {
      role: "Computer Support/IT Assistant (Internship)",
      ...
      descBullets: [
        " Improved efficiency by 20%: Identified outdated and inefficient hardware and software systems and replaced them with modern, high-performance solutions",
        "Troubleshoot issues with hardware, software, and peripherals",
        "Created and Conducted end-user training",
        "Served as a technical contact at all times"
